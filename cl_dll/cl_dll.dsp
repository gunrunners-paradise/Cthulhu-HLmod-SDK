...
# ADD CPP /nologo /MT /W3 /GX /Zi /O2 /Ob0 /I "..\utils\vgui\include" /I "..\engine" /I "..\common" /I "..\pm_shared" /I "..\dlls" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /YX /FD /c
...
"d:\sierra\half-life\cthulhudev\cl_dlls\client.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\client.dll d:\sierra\half-life\cthulhudev\cl_dlls\client.dll
