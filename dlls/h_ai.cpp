...
Vector VecCheckToss ( entvars_t *pev, const Vector &vecSpot1, Vector vecSpot2, float flGravityAdj )
{
	...
	{
		// to high, fail
		//ALERT(at_console,"CheckToss failed check 1\n");
		return g_vecZero;
	}
	...
	if (vecMidPoint.z < vecSpot1.z || vecMidPoint.z < vecSpot2.z)
	{
		...
		//ALERT(at_console,"CheckToss failed check 2\n");
		return g_vecZero;
	}
	...
	{
		// too close
		//ALERT(at_console,"CheckToss failed check 3\n");
		return g_vecZero;
	}
	...
	{
		// fail!
		//ALERT(at_console,"CheckToss failed check 4\n");
		return g_vecZero;
	}
	...
	{
		// fail!
		//ALERT(at_console,"CheckToss failed check 5\n");
		return g_vecZero;
	}
	
	//ALERT(at_console,"CheckToss passes!\n");
