...
void CthStreakSplash( const Vector &origin, const Vector &direction, int color, int count, int speed, int velocityRange )
{
...
void CCthulhu :: FlameUpdate( void )
{
	...
	for ( i = 0; i < 1; i++ )
	{
		if ( m_pFlame[i] )
		{
			...
			{
				CthStreakSplash( trace.vecEndPos, trace.vecPlaneNormal, 6, 20, 50, 400 );
				streaks = TRUE;
